...
def test_create_command():
    ...
    result = main(["create", "test_agent", "test_role", "--skills", "skill1", "skill2"])
    assert result == 0

    # Test creation with goal
    result = main(["create", "test_agent", "test_role", "--goal", "test goal"])
    assert result == 0
...
def test_execute_command():
    ...
    result = main(["execute", "test_agent", "test task"])
    assert result == 0
